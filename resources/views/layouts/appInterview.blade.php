...
<ul id="slide-out" class="side-nav fixed" style="width:300px; background-color: black; background-size: 1500px; background-repeat: no-repeat;">
        <li><div class="userView">
            <li style="background-color:black"><a href="" class="brand-logo">&nbsp; <font color="white" size="3"><strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Hello POC: </strong></font></a></li>
