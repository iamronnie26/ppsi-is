									...
									<tr>
										...
										$(function() {
											...
											$('#users-table').DataTable({
												processing: true,
												//serverSide: true,
												ajax: '{{url("admin/applicants/data_all")}}',
												columns: [
										...
										window.location.href = '/admin/applicants/all/delete/'+id;
										});
									});
								</script>
				</div>					
	...
	<div class="col s12 m12 l3 right-panel">
		...
		<div class="card" style="background-color:#009CFE">
			<div class="card-content">
				...
				<div class="card-body">
				<ul>
					<li><font color="white">Total Showups: <span class="new badge"> {{ $applicants_countAll }}</span></font></li><br/>
					<div class = "divider"></div><br/>
					<li><font color="white">Call Center: <span class="new badge">{{$applicants_countAllJob}} </span></font></li>
					<li><font color="white">Internal: <span class="new badge"> {{ $applicants_countAllInternal	}}</span></font></li>
					<li><font color="white">Training: <span class="new badge"> {{$applicants_countAllTraining}} </span></font></li>
				</ul>
				</div>
			</div>
		</div>
		...
		<div class="card" style="background-color:#735AF2">
			<div class="card-content">
				...
				<ul>
					<li><font color="white">Total No. of Users: <span class="new badge"> {{ $admin_userAll }}</spam></font></li>
				</ul>
			</div>
		</div>	
		...
		<div class="card" style="background-color:#4FD05D">
			<div class="card-content">
				...
				<ul>
					<li><font color="white">Total No. of Business Partners: <span class="new badge">{{ $business_partnerAll }}</span></font></li>
				</ul>
			</div>
		</div>	
		</div>
