								...
								<thead>
									<tr>
										...
										$("#btnYes").click(function(){
											...
											window.location.href = '/admin/applicants/today/delete/'+id;
										});
									});
										</script>
				</div>					
...
<div class="col s12 m12 l3 right-panel">
		...
		<div class="card" style="background-color:#009CFE">
			<div class="card-content">
				...
				<div class="card-body">
				<ul>
					<li><font color="white">Call Center: <span class="new badge"> {{ $applicants_countToday }}</span></font></li>
					<li><font color="white">Internal: <span class="new badge"> {{ $applicants_InternalToday }}</span></font></li>
					<li><font color="white">Training: <span class="new badge"> {{ $applicants_TrainingToday }}</span></font></li>
				</ul>
				</div>
			</div>
		</div>
		...
		<div class="card" style="background-color:#735AF2">
			<div class="card-content">
				...
				<ul>
					<li><font color="white">Total No. of Users: <span class="new badge"> {{ $admin_userToday }}</spam></font></li>
				</ul>
			</div>
		</div>	
		...
		<div class="card" style="background-color:#4FD05D">
			<div class="card-content">
				...
				<ul>
					<li><font color="white">Total No. of Business Partners: <span class="new badge">{{ $business_partnerToday }}</span></font></li>
				</ul>
			</div>
		</div>	
		</div>
