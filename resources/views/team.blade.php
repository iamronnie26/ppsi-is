...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    ...
    &nbsp;&nbsp;&nbsp;<a href="/" class="btn"><i class="small material-icons">arrow_back_ios</i></a><br/><br/>

      <div class="container">
        <h1 class="team"><b>MEET OUR TEAM</b></h1>
        <style>
            .team{
            text-shadow: horizontal-offset vertical-offset blur color;
            text-shadow: 2px 4px 3px rgba(2,1,0,0.6);
    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12 center">
          ...
          <h4><b>PPSI Integrated Software</b></h4>
    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text"><b>PPS Inc.</b></h5>
