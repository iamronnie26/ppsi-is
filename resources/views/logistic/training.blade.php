...
@section('title','Home Page | Training')
@section('content')
	...
	<div class="col s12 m12 19">
		...
		<div class="card maincard">
			<div class="card-content">
				<span class="card-title">Trainee's Information</span>
				<div class="row">
					<div class="col s12">
				...
				<div class="row">
					<div class="col s12">
						<div class= "table-container">
							<table class="highlight centered" id="userTraining-table">
								<thead>
									<tr>
									<th>ID</th>
                                    <th>Date and Time</th>
							...
							<script>
										$(function() {
											...
											window.table = $('#userTraining-table').DataTable({
												processing: true,
												//serverSide: true,
												ajax: '{{url("logistic/training/dataTraining")}}',
												columns: [
