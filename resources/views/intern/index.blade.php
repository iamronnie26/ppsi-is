		...
		<div class="col s12 m12 l9">
			...
			<div class="row">
					<div class="col s12 m12 centered" id="controls">
						<a href="{{ route('intern.add') }}" class="btn"><i class= "small material-icons">add</i><span>ADD</span></a>
								...
								<thead>
									<tr>
										...
										$('#user-table tbody').on('click', '.btn', function(){
											...
											window.location.href = '/recept/intern/edit/'+id;
										});
