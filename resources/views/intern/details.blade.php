 ...
 <div class="card" style="width: 1000px">
    <div class="card-image waves-effect waves-block waves-light">
    	 <div class="card-panel" style="background-color:#191970">
					<h4><font color="white">Add New Applicant</font></h4></div>&nbsp; <a href="{{ route('intern.index') }}" class="label label-primary pull-right"><button type="button" class="btn btn-dark">Back</button></a><br/><br/>
	...
	<div class="col-xs-12 col-sm-12 col-md-12">
		<div class="form-group">
			<strong>Fullname of Intern:</strong>
			{{ $interns->firstname }}  {{ $interns->middlename }}  {{ $interns->lastname }}
		</div>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12">
		<div class="form-group">
