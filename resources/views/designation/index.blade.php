...
@section('title', 'Dashboard | Designation')
@section('content')
	...
	<div class="col s12 m12 19">
		...
		<div class="card maincard">
			<div class="card-content">
				<span class="card-title">Designation Maintenance</span>
				<div class="row">
					<div class="col s12">
						<form action="#" method="post">
							<div class="col s12 m12 centered" id="controls">
								<a href="{{ route('designation.add') }}" class="btn"><i class= "small material-icons">add</i><span>ADD</span></a>
							</div>
							...
							<script>
										$(function() {
											...
											$('#user-table').DataTable({
												processing: true,
												serverSide: true,
												ajax: '{{url("admin/designation/data")}}',
												columns: [
													{
														"defaultContent":
										...
										window.location.href = "/admin/designation/delete/"+id;
										});
									});

									$('#user-table tbody').on( 'click', '.btn-edit', function () {
										var id = $(this).parent().next().text();
										window.location.href = "/admin/designation/edit/"+id;
